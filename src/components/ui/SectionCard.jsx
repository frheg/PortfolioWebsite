...
export default function SectionCard({
  ...
  return (
    <section
      ref={sectionRef}
      id={id}
      className={`relative z-10 my-16 scroll-mt-6 overflow-hidden rounded-[1.5rem] border border-white/10 bg-slate-950/40 p-4 shadow-[0_30px_80px_rgba(17,17,27,0.45)] backdrop-blur-xl sm:my-20 sm:rounded-[2rem] sm:p-6 md:my-28 md:p-8 ${className}`}
