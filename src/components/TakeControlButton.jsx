...
export default function TakeControlButton() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+4.6rem)] z-30 flex justify-center px-4 md:bottom-6 md:justify-end md:pr-6">
      <Link
        to="/explore"
